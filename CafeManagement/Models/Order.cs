...
namespace CafeManagement.Models
{
    public class Order
    {
        ...
        public Models.LinkedList<OrderItem> Items { get; set; }   // Danh sách sản phẩm trong đơn hàng

        public Order(int id, int customerId, DateTime orderDate, Models.LinkedList<OrderItem> items)
        {
            Id = id;
