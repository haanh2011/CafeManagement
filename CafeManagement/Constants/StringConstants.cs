...
namespace CafeManagement.Constants
{
    ...
    {
        public const string FORMAT_DATE = "d/M/yyyy";
        ...
        public const string INPUT_X = "Nhập {0}: ";
        public const string ADD_X = "Thêm {0}";
        public const string UPDATE_X = "Chỉnh sửa {0}";
        public const string DELETE_X = "Xóa {0}";
        public const string FIND_X = "Tìm kiếm {0}";
        ...
        public const string ENTER_THE_INFORMATION_OF_X_TO_ADD = "Nhập thông tin của {0} mới: ";
        ...
        public const string INPUT_NAME_OF_X_NEW = "Nhập tên {0} mới: ";
        public const string INPUT_NAME_OF_X = "Nhập tên {0}: ";
        ...
        public const string X_HAS_BEEN_DELETE = "{0} đã được xóa";
        public const string X_HAS_BEEN_UPDATE = "{0} đã được cập nhật";
        public const string INPUT_X_NEW = "Nhập {0} mới";
        public const string ADD_X_NEW = "Thêm {0} mới";
